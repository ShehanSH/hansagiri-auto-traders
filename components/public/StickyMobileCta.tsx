  ...
  return (
    <div className="fixed inset-x-0 bottom-0 z-30 grid grid-cols-2 border-t border-gold/20 bg-dark/95 p-3 backdrop-blur lg:hidden">
      {tel ? (
        <a
          href={tel}
          className="mr-1 flex items-center justify-center gap-2 bg-gold py-3 text-xs uppercase tracking-[0.16em] text-dark"
        >
      ...
      {wa ? (
        <a
          ...
          className="ml-1 flex items-center justify-center gap-2 border border-gold py-3 text-xs uppercase tracking-[0.16em] text-gold"
        >
